import styles from '../../css/components-css/design-card-css/landscape-game-item.module.css';
import { addFavorite, getFavorites, removeFavorite } from '../../../Backend/utils/auth';
import { useEffect, useState } from 'react';
import { Link } from 'react-router';

function LandscapeGameItem({ user, onSuccess, onError, link, img, tag, title, des, price }) {
