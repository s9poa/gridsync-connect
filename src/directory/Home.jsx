    ...
    <main>
      <section className={styles.hero}>
        <div className={styles["target-items"]}>
          ...
          {activeIndex === 0 && <Hero img="/home/ac-mirage.webp" gameTitle ="Assassin's Creed Mirage" title="Discover a Tribute to the Original" des="Experience a mordern take on the iconic features and gameplay that have defined a franchise for 15 years." ctaLink="/" ctaText="Get it now" />}
          ...
          {activeIndex === 3 && <Hero img="/home/far-cry-6.webp" gameTitle ="Far Cry 6" title="Ready for Your Next Adventure?" des="Discover Fary Cry 6 and take down the tyrannical dictaor Anton Castillo." ctaLink="/" ctaText="Play now" />}
        ...
        <div className={styles.gradientSizingContainer}>
          <div className={styles["target-container"]}>
            <HeroTargeter img="/home/ac-mirage.webp" gameTitle="Assassin's Creed Mirage" title="Discover a Tribute to the Original" onClick={() => handleManualSwitch(0)} className={activeIndex === 0 ? styles.active : ""} />
            ...
            <HeroTargeter img="/home/far-cry-6.webp" title="Ready for Your Next Adventure?" onClick={() => handleManualSwitch(3)} className={activeIndex === 3 ? styles.active : ""} />
          </div>
      ...
      <section className="main-content-section">
        ...
        <div className="main-content-section-grid grid-4">
          ...
          <LandscapeBox img="/home/r6-bundle.avif" subTitle="Rainbow Six Siege X" title="New R6 Share Pro Team Bundles Are Live" date="6 days ago" />
          <LandscapeBox img="/home/r6-showdown.avif" subTitle="Rainbow Six Siege X" title="New Twitch Drops For Siege X's Showdown Event" date="6 days ago" />
          <LandscapeBox img="/home/crew-june-24.avif" subTitle="The Crew Motorfest" title="This Week in The Crew - June 24" date="6 days ago" />
        </div>
      </section>
